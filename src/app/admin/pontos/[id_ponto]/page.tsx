  ...
  return (
    <>
      ...
      >
          ...
          <>
            ...
            <div className="flex">
              ...
              <a
                className="flex justify-center"
                href={
                  currentAmontante ? '/admin/pontos/' + currentAmontante : '#'
                }
        ...
        <label>QR code:</label>
        <QRCode
          data={process.env.NEXT_PUBLIC_BASE_URL + '/pontos/' + params.id_ponto}
          width={150}
        />
