    ...
    <>
      ...
      {solicitacao && pontos.length > 0 && (
        <>
          ...
          >
            ...
            <div className="flex">
              ...
              <a
                ...
                href={codEdificacao ? '/admin/pontos/' + codEdificacao : '#'}
                target={codEdificacao ? '_blank' : '_self'}
              >
                <svg
                  className={
                    codEdificacao
            ...
            <div className="flex">
              ...
              <a
                className="flex justify-center"
                href={idPonto ? '/admin/pontos/' + idPonto : '#'}
                target={idPonto ? '_blank' : '_self'}
              >
                <svg
                  className={
                    idPonto
            ...
            <textarea
              ...
              className="w-full rounded border border-neutral-300 px-4 py-2 disabled:bg-neutral-200 disabled:text-neutral-500"
            />
          ...
          <button
            onClick={() => downloadSolictacao(parseInt(id_solicitacao))}
            className="w-full rounded-lg border bg-primary-500 px-6 py-4 text-center font-semibold text-white hover:bg-primary-700"
          >
            Baixar documento
          </button>
        </>
