...
export default function CriarColeta({
  ...
  const pontos: Ponto[] = usePontosAmontante(
    sequencia?.ponto ? sequencia.ponto : null,
  );
      ...
      >
        ...
        <div className="flex gap-4">
          ...
          <input
            ...
            id="data"
            name="data"
            className="flex-grow rounded-lg border border-neutral-400 px-6 py-4"
        ...
        >
          {usuarios.map((usuario) => {
            return (
              <option value={usuario.id} key={'usuario' + usuario.id}>
                {usuario.username}
              </option>
            );
          })}
