...
export default function Navbar(props: {
    ...
    return (
        <div id="navbar-wrapper" className={`fixed ${props.collapsed ? 'w-0' : 'w-60'} h-screen flex flex-col overflow-hidden shadow-lg transition-all`}>
            ...
            <div id="navbar-content" className="grow bg-background border-r border-r-neutral-300 ">
                <ul>
                    { navbar_links.map((link) => {
                        return (
                            <li className="text-xl hover:bg-[#c1c2c4]"> 
                                <a 
                                    href={ link.href }
                                    className="min-h-12 flex gap-3 box-border p-4 text-[#516c79] m-3 rounded-md leading-6"
                                >
                                    { link.icon }
                                    { link.name }
                                </a>
